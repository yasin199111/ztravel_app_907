CLASS zcl_generate_travel_data_907 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS ZCL_GENERATE_TRAVEL_DATA_907 IMPLEMENTATION.


  METHOD if_oo_adt_classrun~main.

    DATA itab TYPE TABLE OF ztravel_907.
...
*   delete existing entries in the database table
    DELETE FROM ztravel_907.

*   insert the new table entries
    INSERT ztravel_907 FROM TABLE @itab.
